...
import { RefreshCw, Star, CheckCircle2, Clock, FileText } from 'lucide-vue-next'
    ...
    <main class="px-4 py-4">
      ...
      <div v-else class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div
          ...
          :key="book.id"
          @click="openBook(book)"
          class="bg-white dark:bg-gray-800 rounded-xl p-4  flex flex-col justify-between shadow-sm hover:shadow-lg transition-all cursor-pointer border border-gray-200 dark:border-gray-700"
        >
